...
{
    let input = document.getElementById("search_products"); //Input que trae la informacion que quiero traer
...
function fetch_serch(busqueda_text) //Funcion de buscador
{
    ...
    .then(function(texto) 
    {
        ...
        document.querySelector("#cuerpo_tabla_productos").innerHTML = ""; //Limpio la tabla
        document.querySelector("#cuerpo_tabla_productos").innerHTML = texto; //Lleno la tabla con los datos
    })
